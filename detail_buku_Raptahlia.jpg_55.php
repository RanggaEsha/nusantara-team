  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="./Daftarbuku/Promo/Raptahlia.jpg"><img id="imagePreview"  src="./Daftarbuku/Promo/Raptahlia.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">Pintar</p>
