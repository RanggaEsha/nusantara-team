  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="./Daftarbuku/Promo/wallpaper.jpg"><img id="imagePreview"  src="./Daftarbuku/Promo/wallpaper.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          <h1 id="judulPreview" name = "judul">Promo</h1>
          <hr>
          <div class="rating">
            <span>&#9733;</span>
            <span>&#9733;</span>
          ...
          <p id="pengarang" name="pengarang">Menarik</p>
