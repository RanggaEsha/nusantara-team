  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="./Daftarbuku/BestSeller/5cad9da8e875a5a48b0bc897c8434ae2.png"><img id="imagePreview"  src="./Daftarbuku/BestSeller/5cad9da8e875a5a48b0bc897c8434ae2.png" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">Buku Best</p>
          <p id="harga" name="harga">99999</p>
