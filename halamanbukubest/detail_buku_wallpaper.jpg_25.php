  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="../Daftarbuku/BestSeller/wallpaper.jpg"><img id="imagePreview"  src="../BestSeller/wallpaper.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">TESSS</p>
