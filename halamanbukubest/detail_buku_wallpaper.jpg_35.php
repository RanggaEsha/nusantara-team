...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="../checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="../Daftarbuku/BestSeller/wallpaper.jpg"><img id="imagePreview"  src="../Daftarbuku/BestSeller/wallpaper.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">wkwkwkwk</p>
          <p id="harga" name="harga">100000</p>
  ...
  <div class="container-deksripsi">
    <h3>Deskripsi :</h3>
    <hr>
    <p>hhhhhhhhhhhhhhhhakwokoawko woy totol wkowkowo ccd animal pilat</p>
  <!-- Akhir Modal -->
