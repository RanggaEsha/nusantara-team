  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="./halamanbukubest/BestSeller/Cream Minimalist Coming Soon Twitter Header.png"><img id="imagePreview"  src="./halamanbukubest/BestSeller/Cream Minimalist Coming Soon Twitter Header.png" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">Tolol</p>
