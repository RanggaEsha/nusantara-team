...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="../checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href=".11.jpg"><img id="imagePreview"  src=".11.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          <h1 id="judulPreview" name = "judul">tesssssss</h1>
          <hr>
          <div class="rating">
            <span>&#9733;</span>
            <span>&#9733;</span>
          ...
          <p id="pengarang" name="pengarang">tesssssss</p>
  ...
  <div class="container-deksripsi">
    <h3>Deskripsi :</h3>
    <hr>
    <p style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; max-width: 990px; display: inline-block;">tessssssstessssssstessssssstessssssstessssssstesssssss</p>
  <!-- Akhir Modal -->
