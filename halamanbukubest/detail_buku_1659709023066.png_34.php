...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="../checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="../Daftarbuku/BestSeller/1659709023066.png"><img id="imagePreview"  src="../Daftarbuku/BestSeller/1659709023066.png" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          ...
          <p id="pengarang" name="pengarang">hehe</p>
  ...
  <div class="container-deksripsi">
    <h3>Deskripsi :</h3>
    <hr>
    <p>Rasulullah saw. diutus oleh Allah Swt. untuk menyempurnakan akhlak manusia. Pasalnya, akhlak merupakan salah satu pondasi penting seseorang dalam beragama. Karena akhlak adalah perangai yang melekat pada diri seseorang yang dapat memunculkan perbuatan baik tanpa mempertimbangkan pikiran terlebih dahulu. 
Buku PUNCAK ILMU ADALAH AKHLAK memberikan penjelasan hal-hal yang harus kita ketahui agar kita bisa menunjukkan akhlak terpuji, yaitu akhlak kepada Allah Swt., Rasulullah saw. Al-Qur’an, agama Islam, orang tua, keluarga, guru, saudara dan tetangga. Selain itu, juga akhlak dalam peran-peran kita di keseharian dalam bekerja, berniaga dan juga memimpin.</p>
  <!-- Akhir Modal -->
